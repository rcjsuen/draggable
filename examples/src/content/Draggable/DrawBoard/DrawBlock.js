...
export default class DrawBlock {
  constructor(template, canvas) {
    this.template = template || document.getElementById('DrawBlockTemplate');
    this.canvas = canvas || document.getElementById('DrawBlockCanvas');
  }
  ...
  getPositionFromCanvas(sensorPosition, canvasPosition, initialPosition = defaultInitialPosition) {
    return {
